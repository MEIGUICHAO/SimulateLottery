...
//                    setLastMap(i);
    ...
    private void get2PostionBuyMap() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            if (sortPositionList.size() > 1) {
                sortList(sortPositionList, true);
            }
            if (sortNumList.size() > 1) {
                sortList(sortNumList, false);
            }

        }
    }

    private void sortList(ArrayList<String> sortPositionList, boolean isPosition) {
        ...
        if (Integer.parseInt(sortPositionList.get(0).split("-")[1]) > MAX_2 && ((Integer.parseInt(sortPositionList.get(0).split("-")[1]) - Integer.parseInt(sortPositionList.get(1).split("-")[1])) >= BLANK_2)) {
            ...
            if (isPosition) {
                ...
                Log.e("buyMap", "buyPositionMap: " + sortPositionList.get(0) + "+" + sortPositionList.get(1));
            } else {
                BUY_AMOUNT = BUY_AMOUNT - 20;
                ...
                Log.e("buyMap", "buyNumMap: " + sortPositionList.get(0) + "+" + sortPositionList.get(1));
            }
